export default function CampaignA() {
  return (
    <main className="min-h-screen bg-white text-gray-800 font-sans">
      {/* Header */}
      <header className="relative text-white text-center overflow-hidden">
        <img src="/campaign-a/배너.png" alt="YADAH 배너" className="w-full object-cover" />
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-gray-500 mb-4">공감되는 컨셉을 선택하여 제작해주세요.</p>
